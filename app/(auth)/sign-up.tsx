...
export default function SignUpScreen() {
  ...
  return (
    <ThemedView
      style={[styles.signUpContainer, { backgroundColor: backgroundColor }]}
    >
      ...
      <ThemedView style={styles.formContainer}>
        ...
        <Pressable
          ...
          onPress={() => console.log("Google Sign Up button pressed")}
        >
          <ThemedText style={styles.buttonText}>Google Sign Up</ThemedText>
        </Pressable>
        <ThemedText
